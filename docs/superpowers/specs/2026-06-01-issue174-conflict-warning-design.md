...
> **Maintenance note (2026-06-25):** GAP-005 closed by strengthening expectation management in known-conflict data, docs, and policy tests. The incompatibility remains intentionally unsolved in one process; OData preload reclassification requires fresh runtime re-adjudication in both import orders.
