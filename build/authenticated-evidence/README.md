...
- exact bundle-source fingerprint, including packaging logic and pinned build tooling;
- byte-level prepared module-inventory fingerprint per exact profile and checkpoint;
...
- exactly 14 days of validity from capture-session start, with no resume renewal;
