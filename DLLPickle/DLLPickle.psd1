...
Description = 'A PowerShell module that helps you get un-stuck from dependency version conflicts (aka DLL pickle) that often occur when using modules that depend on different versions of the Microsoft Authentication Library (MSAL).'
