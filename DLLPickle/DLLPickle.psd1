#
# Module manifest for module 'DLLPickle'
#
...
@{
    ...
    Description       = 'A PowerShell module that helps you get un-stuck from dependency version conflicts (aka DLL pickle) that often occur when trying to connect to multiple Microsoft services.'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            Tags         = @('DLL', 'Dependency Management', 'Version Conflict', 'PowerShell', 'Windows', 'Microsoft Graph', 'Azure', 'SharePoint', 'Teams', 'Microsoft 365', 'Exchange Online')
