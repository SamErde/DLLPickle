...
@{
    ...
    FunctionsToExport = @('Find-DLLInPSModulePath', 'Get-ModuleImportCandidate', 'Get-ModulesWithDependency',
        'Get-ModulesWithVersionSortedIdentityClient', 'Import-DPLibrary')
    #'Find-Library','Get-NewestFileVersion','Get-NewestFileVersionCompatible'
